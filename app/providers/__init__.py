"""Provider 工厂：根据配置返回 Embedder / LLM / Reranker 实例。"""
...
from app.providers.rerank import DashScopeReranker, Reranker
...
def get_reranker() -> Reranker:
    # DashScope 在线重排（qwen3-rerank，通过 base_url / api_key / model 切换）
